...
UUITweenInstance* UUITweenInstance::TweenFloatProperty(float startValue, float targetValue)
{
	return NULL;
}
...
{
	this->_materialScalarProperties = TArray<UUITweenMaterialScalarProperties*>();
	this->_materialVectorProperties = TArray<UUITweenMaterialVectorProperties*>();
}
