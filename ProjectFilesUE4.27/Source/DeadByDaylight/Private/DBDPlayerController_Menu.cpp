...
void ADBDPlayerController_Menu::Server_SetCustomizationMeshes_Implementation(const FCharacterCustomization& customization)
{

}

bool ADBDPlayerController_Menu::Server_SetCustomizationMeshes_Validate(const FCharacterCustomization& customization)
{
	return true;
}
