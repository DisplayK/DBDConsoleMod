...
UUMGPlayerStatusIcon::UUMGPlayerStatusIcon()
{
	...
	this->SicknessFillHighOpacity = 0.000000;
	this->SicknessFillLowOpacity = 0.000000;
	...
	this->UMGStalkingStatusEffectUIClass = NULL;
	this->UMGLacerationStatusEffectUIClass = NULL;
