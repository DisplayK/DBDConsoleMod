...
{
	this->_sicknessAmount = 0.000000;
	this->_sicknessCap = 0.000000;
	this->_vomitSlowDuration = 0.000000;
	this->_vomitSlowAmount = 0.000000;
	this->_sicknessThresholds = TArray<float>();
	this->_wasRecentlyHitByVomit = false;
	this->_nonNauseatingInteractions = TArray<FString>();
	this->_debugMode = false;
	this->_exposeMaximumSickSurvivorEffect = NULL;
	this->_brokenMaximumSickSurvivorEffect = NULL;
}
