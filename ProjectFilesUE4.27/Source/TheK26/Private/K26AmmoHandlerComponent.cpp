...
void UK26AmmoHandlerComponent::CallOnMaxAmmoSet(FOnMaxAmmoSetDelegate callback)
{
...
{
	this->_rechargeEndTime = 0.000000;
	this->_isTunableInit = false;
	this->_projectileClass = NULL;
	this->_firedCooldownTimesPerCrow = TArray<FDBDTunableRowHandle>();
	this->_currentAmmo = -1;
	...
	this->_fallbackFireCooldown = 20.000000;
}
