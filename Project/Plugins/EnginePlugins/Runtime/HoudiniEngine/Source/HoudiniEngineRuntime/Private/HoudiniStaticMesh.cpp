...
UHoudiniStaticMesh::UHoudiniStaticMesh()
{
	...
	this->VertexPositions = TArray<FVector>();
	this->TriangleIndices = TArray<FIntVector>();
	this->VertexInstanceColors = TArray<FColor>();
	this->VertexInstanceNormals = TArray<FVector>();
	this->VertexInstanceUTangents = TArray<FVector>();
	this->VertexInstanceVTangents = TArray<FVector>();
	this->VertexInstanceUVs = TArray<FVector2D>();
	this->MaterialIDsPerTriangle = TArray<int32>();
	this->StaticMaterials = TArray<FStaticMaterial>();
}
