...
void UTallyScreen::OnReportPlayerButtonClick(const FString& playerId)
{
...
void UTallyScreen::OnPlayerOptionClick(const FString& krakenId, const FString& playerId, uint8 option)
{

}

void UTallyScreen::OnPlayerInfoClick(const FString& playerId)
{
