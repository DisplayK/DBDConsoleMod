...
UEndGameStateComponent::UEndGameStateComponent()
{
	...
	this->_worldTimeAtLastModification = 0.000000;
	this->_timeDilation = 1.000000;
	this->_isTimerPaused = false;
	this->_normalTotalTimeElapsedAtLastTimeModification = 0.000000;
	this->_endGameScenarioTrigger = EEndGameScenarioTrigger::ClosedHatch;
}
