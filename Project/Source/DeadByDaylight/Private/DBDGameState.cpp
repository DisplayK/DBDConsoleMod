...
void ADBDGameState::Multicast_SetBuiltLevelData_Implementation(const FName& themeName, const FName& themeWeather, const FName& audioStateThemes, const FName& audioStateWeather, const FName& audioThemeEvent, const FName& audioLimitPointEvent, const TSoftObjectPtr<UAkAudioBank>& audioThemeSoundBank, const FString& mapName, int32 tileCount, const TArray<FDependency>& levelDependencies, const FName& specialEventId)
{
...
void ADBDGameState::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME(ADBDGameState, _numberOfSurvivorKilled);
...
ADBDGameState::ADBDGameState()
{
	...
	this->_numberOfSurvivorKilled = 0;
